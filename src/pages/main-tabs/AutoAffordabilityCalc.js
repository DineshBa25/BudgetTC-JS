...
export const AutoAffordabilityCalcView = ({activeFormData}) => {
    ...
    let state1 = {
        ...
        series: [
            ...
            {
                name: "Somewhat Contribution",
                type: "area",
                data: somewhatAffordableOCArray,
                color: "#003fe0"
            },
            {
                name: "Contribution",
                type: "area",
                data: affordableOCArray,
                color: "#ffa500"
            },
            {
                name: "Salary",
                type: "area",
                data: veryAffordableOCArray,
                color: "#ce4d44"
    ...
    return (
        <div style={{paddingLeft: 10, paddingRight: 10, paddingTop: 15, minWidth: 500}}>
            ...
            <Stack wrap style={{paddingBottom: 20}} spacing={10} justifyContent={"center"}>
                ...
                <Panel header={<div ><h7>Subsequent Value Estimation</h7> <IconButton icon={<OthersIcon />} style={{height: 40}} appearance={"subtle"}></IconButton></div>} bordered
                       style={{maxWidth: 400, background: "rgba(0,0,0,0.24)"}}>
